...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getSecurity_User_Provider_Concrete_HardcodedService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('robbert', 'project3', array(0 => 'ROLE_SUPER_ADMIN')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('phedra', 'project3', array(0 => 'ROLE_SUPER_ADMIN')));

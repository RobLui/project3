 ...
 * bug #10958 [DomCrawler] Fixed filterXPath() chaining loosing the parent DOM nodes (stof, project3kl)
 ...
 * bug #10207 [DomCrawler] Fixed filterXPath() chaining (project3kl)
 * bug #10205 [DomCrawler] Fixed incorrect handling of image inputs (project3kl)
